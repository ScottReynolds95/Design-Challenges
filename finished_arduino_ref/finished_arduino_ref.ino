...
// Please note: all of the arduino code is taken from the example found at http://www.geekmomprojects.com/gyroscopes-and-accelerometers-on-a-chip/
// at no point have i edited this program, i have simply used it to take the data from my board and send it to my processing sketch
